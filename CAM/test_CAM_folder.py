...
wrapper.instantiate()
checkpoint = torch.load('/data/lishichao/project/Foundation-Medical/results/v4/checkpoints/All_sheet18_withorgan_lr5e4/4/roc_auc')
model = wrapper.model
...
process_path = '/data/lishichao/project/Foundation-Medical/CAM/val_imgs/fold_4'
